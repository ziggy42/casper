...
![Casper running in a terminal](assets/casper-demo.png)
...
For a temporary machine where you do not want a key in the shell history, leave these variables unset. Casper will ask you to pick a provider and enter its key interactively; the key is hidden while you type and is kept only for that Casper process.
